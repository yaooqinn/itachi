...
class PostgreSQLIntervalUtilsTest extends FunSuite {
  ...
  test("justify days") {
    ...
    assert(PostgreSQLIntervalUtils.justifyDays(
      safeStringToInterval("-1 month -35 day")) ===
      new CalendarInterval(-2, -5, 0))
    assert(PostgreSQLIntervalUtils.justifyDays(safeStringToInterval("-1 month 2 day")) === new CalendarInterval(0, -28, 0))
  }
  ...
  test("justify interval") {
    assert(PostgreSQLIntervalUtils.justifyInterval(safeStringToInterval("1 month 29 day 25 hour")) ===
